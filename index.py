        ...
        <header class="bg-white border-b border-slate-200 p-4 flex flex-col gap-4 shadow-sm z-10 shrink-0">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <img src="/static/logo_nemesis.jpeg" alt="Nemesis Logo" class="h-10 border border-slate-200 rounded">
                    <div>
                        <h1 class="text-xl font-black uppercase tracking-wider text-slate-900">Lionsgate Nemesis Engine</h1>
                        <p class="text-xs text-blue-600 font-mono mt-1">EVIDENTIARY TRACING GRAPH | PRODUCTION ENVIRONMENT</p>
                    </div>
                </div>
                <div class="flex gap-3 items-end">
                    <button onclick="toggleLogModal()" class="bg-slate-200 hover:bg-slate-300 text-slate-700 px-4 py-2 rounded text-xs font-bold shadow transition flex items-center gap-2 h-10">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path></svg>
                        Evidentiary Transaction Log
                    </button>
                    <button onclick="submitTrace()" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-xs font-bold shadow transition flex items-center gap-2 h-10">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        Run Parallel Trace
                    </button>
                    <button onclick="triggerGeneratePDF()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded text-xs font-bold shadow transition flex items-center gap-2 h-10">
            ...
            <div class="flex gap-4">
                <div class="flex-grow">
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Seed Wallets (One per line)</label>
                    <textarea id="seed-input" class="w-full h-16 text-xs border border-slate-300 rounded p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 font-mono" placeholder="0x..."></textarea>
                </div>
                <div class="w-40">
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Start Date</label>
                    <input type="date" id="start-date" class="w-full text-xs border border-slate-300 rounded p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 h-16">
                </div>
                <div class="w-40">
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">End Date</label>
                    <input type="date" id="end-date" class="w-full text-xs border border-slate-300 rounded p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 h-16">
                </div>
                <div class="w-40">
                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Target Amount</label>
                    <input type="number" id="target-amount" class="w-full text-xs border border-slate-300 rounded p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 h-16" placeholder="e.g. 80000">
                </div>
            </div>
        </header>
